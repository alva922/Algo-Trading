...
# get full access to EODHD APIs with this 10% discount https://eodhd.com/pricing-special-10?via=aiva
...
# EODHD crypto endpoint (historical daily data)
url = f"https://eodhd.com/api/eod/BTC-USD.CC?api_token={API_KEY}&period=d&fmt=json"
...
# Keep last 10 years (if dataset is longer)
df = df.last('10Y')
...
mpf.plot(
    ...
    volume=True,
    style='charles',
    title='BTC-USD Candlestick Chart  & Volume',
    ylabel='Price (USD)',
...
plt.title(
    "Bayesian Optimized MAMA Strategy vs Buy & Hold"
)
