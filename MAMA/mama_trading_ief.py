...
# get 10% discount EODHD APIs premium  https://eodhd.com/pricing-special-10?via=aiva
...
df = ief[['open', 'high', 'low', 'close', 'volume']]
...
mpf.plot(
    ...
    volume=True,
    style='charles',
    title='IEF Candlestick Chart & Volume',
    ylabel='Price (USD)',
    xlabel='Date',
    ylabel_lower='Volume',figsize=(14, 6)
)
df_base = pd.DataFrame(index=ief.index)
df_base["price"] = ief["close"]
